...
"""
            ...
            try:
                try:
                    ...
                    # Check if vector_store was created successfully
                    if not vector_store or not vector_store.id:
                        raise ValueError("Failed to create vector store.")

                    # Add the knowledge file to the vector store
                    ...
                    logging.error(f"Failed to create assistant or upload knowledge file: {e}")
                    raise
